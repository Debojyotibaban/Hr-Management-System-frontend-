...
export class EmployeeeducationdropdownService {
  private userURL1 = "http://localhost:8080/qualification/ugQualification";
  private userURL2 = "http://localhost:8080/qualification/ugSpecialization";
  private userURL3 = "http://localhost:8080/qualification/ugUniversity";
  private userURL4 = "http://localhost:8080/qualification/pgQualification";
  private userURL5 = "http://localhost:8080/qualification/pgSpecialization";
  private userURL6 = "http://localhost:8080/qualification/pgUniversity";
